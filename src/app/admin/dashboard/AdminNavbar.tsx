    ...
    <nav style={{
      ...
      <div style={{ maxWidth: '80rem', margin: '0 auto', display: 'flex', alignItems: 'center', justifyContent: 'space-between', height: '4rem', padding: '0 1.5rem', gap: '1rem' }}>
        ...
        <Link href="/admin/dashboard" style={{ display: 'flex', alignItems: 'center', gap: '0.625rem', textDecoration: 'none', flexShrink: 0 }}>
          ...
          <span style={{ fontSize: '0.625rem', fontWeight: 800, padding: '0.2rem 0.5rem', borderRadius: '9999px', background: 'linear-gradient(135deg, rgb(185,28,28), rgb(127,29,29))', color: 'white', fontFamily: 'Syne, sans-serif', letterSpacing: '0.08em', textTransform: 'uppercase' }}>
            ADMIN
          </span>
        </Link>
            ...
            return (
              <Link key={link.href} href={link.href}
                style={{
                  ...
                  boxShadow: isActive ? 'inset 3px 0 0 rgb(34,85,14)' : 'none',
                }}
        ...
        <div style={{ position: 'relative', flexShrink: 0 }} ref={ref}>
          <button onClick={() => setOpen(o => !o)}
            ...
            <div style={{ width: '1.875rem', height: '1.875rem', borderRadius: '50%', background: 'linear-gradient(135deg, rgb(220,38,38), rgb(153,27,27))', display: 'flex', alignItems: 'center', justifyContent: 'center', color: 'white', fontSize: '0.8125rem', fontWeight: 700 }}>
          ...
          {open && (
            <div style={{ position: 'absolute', right: 0, top: 'calc(100% + 0.5rem)', width: '15rem', background: 'rgb(18,18,28)', borderRadius: '0.875rem', boxShadow: '0 20px 60px rgba(0,0,0,0.5)', border: '1px solid rgba(255,255,255,0.08)', overflow: 'hidden', zIndex: 100 }}>
