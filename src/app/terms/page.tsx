        ...
        <div className="container-base" style={{ padding:'3rem 1.5rem', maxWidth:'48rem' }}>
          ...
          <div style={{ display:'flex', flexDirection:'column', gap:'2.5rem', color:'rgb(26,26,20)', lineHeight:1.8, fontSize:'0.9375rem' }}>
            ...
            <section>
              ...
              <p>By creating an account or using StudySpark ("Service"), you agree to these Terms of Service. If you do not agree, do not use the Service.</p>
            ...
            <section>
              ...
              <p>StudySpark is an AI-powered educational platform that generates study materials including questions and worksheets. The Service uses third-party AI (OpenAI) to generate content.</p>
              <p style={{ marginTop:'0.75rem' }}><strong>Important disclaimer:</strong> AI-generated content may contain errors or inaccuracies. StudySpark is a study aid — not a substitute for your teacher, textbook, or academic institution. Always verify important information with authoritative sources. We are not responsible for academic outcomes.</p>
            </section>
            ...
            <section>
              ...
              <p style={{ marginTop:'0.75rem' }}><strong>Generated content:</strong> Study materials generated by StudySpark are for your personal educational use. You may not resell or commercially distribute generated content.</p>
              <p style={{ marginTop:'0.75rem' }}><strong>Our platform:</strong> The StudySpark platform, design, code, and branding are our property and protected by intellectual property laws.</p>
            </section>
            ...
            <section>
              ...
              <p style={{ textTransform:'uppercase', fontSize:'0.875rem' }}>To the maximum extent permitted by law, StudySpark shall not be liable for any indirect, incidental, special, or consequential damages, including academic outcomes, lost data, or lost profits. Our total liability shall not exceed the amount you paid us in the 12 months preceding the claim.</p>
            </section>
