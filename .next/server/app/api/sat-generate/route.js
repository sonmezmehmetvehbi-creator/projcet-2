...
${w?`
SAT MATH RULES:
- Calculator allowed: ${x?"YES":"NO — questions must be solvable by hand in ~90 seconds"}
...
FORMATTING: Always respond in valid JSON only — no markdown, no preamble, no backticks.`,A="";A=w?`Generate ${h} SAT Math questions for the ${x?"Calculator":"No-Calculator"} module at ${g} difficulty.
