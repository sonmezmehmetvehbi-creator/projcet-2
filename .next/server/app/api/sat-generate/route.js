...
FORMATTING: Always respond in valid JSON only — no markdown, no preamble, no backticks.`,m="";m=d?`Generate ${i} SAT Math questions for the ${p?"Calculator":"No-Calculator"} module at ${l} difficulty.
...
Return JSON: { "questions": [...] }`:`Generate ${i} SAT Reading and Writing questions at ${l} difficulty.
