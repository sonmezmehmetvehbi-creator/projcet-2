"use strict";(()=>{var e={};e.id=341,e.ids=[341],e.modules={72934:e=>{e.exports=require("next/dist/client/components/action-async-storage.external.js")},54580:e=>{e.exports=require("next/dist/client/components/request-async-storage.external.js")},45869:e=>{e.exports=require("next/dist/client/components/static-generation-async-storage.external.js")},20399:e=>{e.exports=require("next/dist/compiled/next-server/app-page.runtime.prod.js")},30517:e=>{e.exports=require("next/dist/compiled/next-server/app-route.runtime.prod.js")},92048:e=>{e.exports=require("fs")},32615:e=>{e.exports=require("http")},35240:e=>{e.exports=require("https")},55315:e=>{e.exports=require("path")},68621:e=>{e.exports=require("punycode")},76162:e=>{e.exports=require("stream")},17360:e=>{e.exports=require("url")},21764:e=>{e.exports=require("util")},6162:e=>{e.exports=require("worker_threads")},71568:e=>{e.exports=require("zlib")},87561:e=>{e.exports=require("node:fs")},84492:e=>{e.exports=require("node:stream")},72477:e=>{e.exports=require("node:stream/web")},58534:(e,t,r)=>{r.r(t),r.d(t,{originalPathname:()=>x,patchFetch:()=>w,requestAsyncStorage:()=>g,routeModule:()=>h,serverHooks:()=>y,staticGenerationAsyncStorage:()=>f});var s={};r.r(s),r.d(s,{POST:()=>m});var i=r(49303),a=r(88716),n=r(60670),o=r(6943),c=r(3370),u=r(26830),l=r(57100),p=r(87070),d=r(54214);async function m(e){let t=new d.ZP({apiKey:process.env.OPENAI_API_KEY});try{let r;let s=await (0,o.f)(),{data:{user:i}}=await s.auth.getUser();if(!i)return p.NextResponse.json({error:"Unauthorized"},{status:401});let a=(0,c.createClient)(process.env.NEXT_PUBLIC_SUPABASE_URL,process.env.SUPABASE_SERVICE_ROLE_KEY),n=await (0,l.h)(a,i.id,"generation");if(n)return p.NextResponse.json({error:"generation_banned",reason:n.reason},{status:403});let{module:d,questionCount:m,difficulty:h}=await e.json(),g=await (0,u.$o)(s,i.id,"sat");if(!g.allowed)return p.NextResponse.json({error:"Daily limit reached",limitReached:!0,isPremium:g.isPremium,bonusRemaining:g.bonus},{status:429});let f="math_no_calc"===d||"math_calc"===d,y="math_calc"===d,x={easy:"Easy (College Board difficulty 1-2): straightforward, single-concept, one clear path to the answer",medium:"Medium (College Board difficulty 3): requires applying a concept or interpreting information, 1-2 steps",hard:"Hard (College Board difficulty 4-5): multi-step reasoning, synthesis of multiple concepts, sophisticated distractors"},w=`You are an expert SAT question writer with 15+ years of experience writing for College Board. You have deep knowledge of the SAT format, question types, difficulty calibration, and distractor construction.
...
DIFFICULTY: ${x[h]??x.medium}

${f?`
SAT MATH RULES:
- Calculator allowed: ${y?"YES":"NO — questions must be solvable by hand in ~90 seconds"}
...
FORMATTING: Always respond in valid JSON only — no markdown, no preamble, no backticks.`,q="";q=f?`Generate ${m} SAT Math questions for the ${y?"Calculator":"No-Calculator"} module at ${h} difficulty.
...
Return JSON: { "questions": [...] }`:`Generate ${m} SAT Reading and Writing questions at ${h} difficulty.
...
Return JSON: { "questions": [...] }`;let b=((await t.chat.completions.create({model:"gpt-4o",messages:[{role:"system",content:w},{role:"user",content:q}],temperature:.7,max_tokens:6e3})).choices[0].message.content??"{}").replace(/```json|```/g,"").trim();b=b.replace(/[\u0000-\u001F\u007F-\u009F]/g," ").trim();try{r=JSON.parse(b)}catch{b=b.replace(/\\(?!["\\/bfnrtu])/g,"\\\\");try{r=JSON.parse(b)}catch{throw Error("Failed to parse AI response. Please try again.")}}let{data:A,error:S}=await s.from("sessions").insert({user_id:i.id,subject:"SAT",grade:"college",topic:"math_no_calc"===d?"SAT Math (No Calculator)":"math_calc"===d?"SAT Math (Calculator)":"SAT Reading & Writing",output_type:"questions",content:r,difficulty:h,is_sat:!0,sat_module:d}).select("id").single();if(S)throw S;return g.isPremium||await (0,u.BL)(s,i.id,"sat",g.usedBonus),p.NextResponse.json({sessionId:A.id})}catch(e){return console.error("SAT generate error:",e),p.NextResponse.json({error:e.message||"Generation failed"},{status:500})}}let h=new i.AppRouteRouteModule({definition:{kind:a.x.APP_ROUTE,page:"/api/sat-generate/route",pathname:"/api/sat-generate",filename:"route",bundlePath:"app/api/sat-generate/route"},resolvedPagePath:"/Users/aysesamanci/projcet-2/src/app/api/sat-generate/route.ts",nextConfigOutput:"",userland:s}),{requestAsyncStorage:g,staticGenerationAsyncStorage:f,serverHooks:y}=h,x="/api/sat-generate/route";function w(){return(0,n.patchFetch)({serverHooks:y,staticGenerationAsyncStorage:f})}}};var t=require("../../../webpack-runtime.js");t.C(e);var r=e=>t(t.s=e),s=t.X(0,[9276,8456,3452,5972,4214,4067],()=>r(58534));module.exports=s})();